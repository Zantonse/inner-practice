...
export default function SectionDivider({
  ...
  const gid = gradientId ?? (accentColor ? `divider-${accentColor.replace(/[^a-zA-Z0-9]/g, '')}` : 'divider-grad');
      ...
      >
        <defs>
          <linearGradient id={gid} x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%"   stopColor={accentColor ?? '#D7C2EE'} stopOpacity="0.6" />
            <stop offset="40%"  stopColor={accentColor ? undefined : '#EDE9FE'} stopOpacity="0.4" />
