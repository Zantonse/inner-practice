...
export const metadata: Metadata = {
  ...
  description:
    'Breathing is the most direct voluntary influence on your autonomic nervous system. Explore 14 breathwork techniques — from the physiological sigh to Wim Hof — organized by category and depth. Science-backed, tradition-rooted.',
  keywords: [
