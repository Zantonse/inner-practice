...
const activeStyles: YogaStyleData[] = [
  { id: 'hatha', name: 'Hatha Yoga', tradition: '11th–14th c. Nath Tradition', intensity: 'Low', ansBenefit: 'A strong parasympathetic enhancer among physical yoga styles. Slow diaphragmatic breathing directly stimulates the vagus nerve, producing HRV improvements of 18–25% and systolic BP reductions of 5–10 mmHg.', description: 'The root of all physical yoga. Hatha means "sun-moon" — the union of opposing forces. Codified in the 14th-century Hatha Yoga Pradipika, it combines postures, breath control, and internal locks as a preparatory path for deeper meditative states. Most modern yoga descends from this tradition via Krishnamacharya.', keyResearch: 'Chu et al. (2017, European Journal of Preventive Cardiology, meta-analysis): yoga significantly improves cardiovascular risk factors including BP, HR, and lipids. Cramer et al. (2014, Mayo Clinic Proceedings): systematic review of 37 RCTs showing positive effects on blood pressure and heart rate.', bestFor: ['Beginners', 'Hypertension', 'Stress reduction', 'Seniors'] },
      ...
      <section id="hip-opening" style={{ padding: 'clamp(3rem, 6vw, 5rem) max(1.5rem, 8vw) clamp(4rem, 7vw, 6rem)', background: 'linear-gradient(180deg, var(--color-cream) 0%, color-mix(in srgb, var(--color-yoga-mid) 8%, var(--color-cream)) 100%)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 360px), 1fr))', gap: 'clamp(2rem, 4vw, 4rem)', maxWidth: '780px' }}>
          ...
          <ScrollReveal>
            ...
            <p style={{ fontSize: '0.875rem', lineHeight: 1.85, marginBottom: '0.75rem' }}>
              The psoas sits adjacent to the sympathetic lumbar chain. When deep openers combine tissue access with stillness and slow breath, incomplete threat responses can complete: tears, trembling, waves of anxiety followed by relief. <strong>This is the body completing unfinished business.</strong>
            </p>
            <p style={{ fontSize: '0.875rem', lineHeight: 1.85, margin: 0 }}>
