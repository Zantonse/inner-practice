        ...
        <div style={{ maxWidth: '860px', textAlign: 'center' }}>
          <ScrollReveal>
            ...
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              {[{ href: '/meditate', label: 'Meditate' }, { href: '/breathe', label: 'Breathe' }, { href: '/reiki', label: 'Reiki' }, { href: '/nervous-system', label: 'Nervous System' }, { href: '/yoga', label: 'Yoga' }, { href: '/somatics', label: 'Somatics' }, { href: '/fascia', label: 'Fascia' }, { href: '/manifest', label: 'Manifest' }, { href: '/practice', label: 'Practice' }].map(link => (
